/*
	SOURCE CODE AI
	JUDUL : PENERAPAN A.I. (ARTIFICIAL INTELLIGENCE) 
			PADA ALAT MONITORING SUHU BERBASIS IOT 
	...
	2.	Muhammad Bastian Hanafi		20.11.3714
	3.	Miftahudin Faiz			20.11.3675
	4.	Satya Tegar Kusuma			20.11.3708
	5.	Muhammad Ilham Hanafi		20.11.3722
...
void setup()
{
    ...
    timer.setInterval(250L, program);
}
